...
Удаление всех данных: удалите keys.json и файлы ключей

GitHub разработчика: VLOD-ZDOV

Текущая версия: 5.2

🛡️ Лицензия

SCmess распространяется под лицензией MIT. Используйте на свой страх и риск.
